<div class="w-full">
    ...
    <div class="mb-6">
        <a href="{{ route('authors.create') }}" name="create"
    ...
    <div class="mb-6 flex items-center gap-4">
        ...
        <!-- Search Box -->
        <div class="relative">
            <input wire:model.live.debounce.300ms="search" type="text" placeholder="SEARCH FOR AUTHOR..."
                ...
                @foreach ($authors as $ad)
                    <tr class="hover:bg-white/5 transition">
                        ...
                        <td class="py-3 flex flex-row items-center justify-center">
                            <a href="{{ route('authors.edit', $ad->id) }}" name="edit{{$ad->id}}"
                                class="text-blue-400 hover:text-blue-300 transition">Edit</a>
                            <a href="{{ route('authors.delete', $ad->id) }}" name="delete{{$ad->id}}"
