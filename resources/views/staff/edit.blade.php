...
<body class="min-h-screen bg-black text-gray-200 font-mono flex">
    ...
    <div class="flex-1 p-10">
        ...
        <h1 class="text-4xl font-bold tracking-widest mb-8">Edit Staff</h1>

        <form action="{{ route('staffs.update', $staff_data->id) }}" method="POST"
            ...
            <div>
                ...
                <input type="text" name="name"
                   ...
                   focus:outline-none focus:border-white transition-all tracking-widest" value="{{ $staff_data->name }}">
            </div>
            <div>
